...
public class MetodoRutas {
    ...
    public void guardarArchivoRutas(Rutas rutas){
        try {
            ...
            FileWriter fw = new FileWriter ("D:\\utpl\\Ingenieria de software\\ProyectVentaBoletos\\Rutas.txt", true);
    ...
    public DefaultTableModel listaRutas(){
        ...
        try {
            FileReader fr = new FileReader("D:\\utpl\\Ingenieria de software\\ProyectVentaBoletos\\Rutas.txt");
